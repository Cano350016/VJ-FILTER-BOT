...
API_ID = int(environ.get('API_ID', '26984934'))
API_HASH = environ.get('API_HASH', '3302a22aae03b6f212cbc4c77e2421d0')
BOT_TOKEN = environ.get('BOT_TOKEN', "7555008164:AAGrLMr_G8POdudCnwbLfV7J2DeOnnAUIWg")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1736977785'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '861859638').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1994476669').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '1736977785') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Canarsiv:ZcjVLje5k7TT2esq@cluster0.ljida.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cano35")
